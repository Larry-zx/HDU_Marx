    ...
    while True:
        ...
        layout = [
            [sg.Text(data[i]["subject"], size=(64, 3), font=20, text_color='Black',
                     auto_size_text=True)],
            [sg.Checkbox("%s" % (data[i]['option']["A"]), default=False, key="A", size=(64, 1), font=20,
                         text_color='navy')],
            [sg.Checkbox("%s" % (data[i]['option']["B"]), default=False, key="B", size=(64, 1), font=20,
                         text_color='navy')],
            [sg.Checkbox("%s" % (data[i]['option']["C"]), default=False, key="C", size=(64, 1), font=20,
                         text_color='navy')],
            [sg.Checkbox("%s" % (data[i]['option']["D"]), default=False, key="D", size=(64, 1), font=20,
                         text_color='navy')],
